...
![Исходное состояние таблицы](documentation/tests/1%20Исходное%20состояние%20таблицы%20USERS.png)

Запрос в Postman
![login и ответ сервера](documentation/tests/2%20login%20и%20ответ%20сервера.png))
